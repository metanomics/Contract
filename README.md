...
contract MetaNomix is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x37E04eF6e3521A36a70a976F8ee52D10de66D3F0); // Marketing Address
...
    string private _name = "MetaNomix";
